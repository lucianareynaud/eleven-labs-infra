    ...
    return {
      ObjectExpression(node) {
        ...
        if (options.value.length < import_constants.MIN_ITEMS_TO_ALPHABETIZE)
          return;
        const sortedOptions = [...options.value].sort(import_utils.utils.optionComparator);
        if (!import_utils.utils.areIdenticallySortedOptions(options.value, sortedOptions)) {
