...
exports.VoiceOperations = void 0;
exports.VoiceOperations = [
                ...
                routing: {
                    request: {
                        ...
                        body: {
                            ...
                            voice_description: '={{$parameter["additionalFields"]["description"] || "Generated with n8n"}}',
                            ...
                            async function (items, responseData) {
                                return items.map((item) => ({
                                    ...
                                    json: {
                                        ...
                                        description: this.getNodeParameter('additionalFields.description', 'Generated with n8n'),
                                        labels: JSON.parse(this.getNodeParameter('additionalFields.labels', '{}')),
                                    },
                                }));
                            },
                        ],
    ...
    // Notice
    {
        displayName: 'This generates a voice and returns a generated_voice_id with an audio sample. If you like the generated voice call "Create Voice" with the generated_voice_id to create the voice.',
        name: 'notice',
        type: 'notice',
        default: '',
        displayOptions: {
    ...
    // Notice
    {
        displayName: 'This creates a voice from a generated_voice_id, generated with the "Generate Voice" operation, and adds it to your library',
        name: 'notice',
        type: 'notice',
        default: '',
        displayOptions: {
...
async function returnBinary(items, responseData) {
    ...
    const file_name = this.getNodeParameter('additionalFields["file_name"]', 'voice');
...
async function preSendUploadAudio(requestOptions) {
    ...
    const description = this.getNodeParameter('additionalFields.description', 'Generated with n8n');
    const labels = this.getNodeParameter('additionalFields.labels', '{}');
